    ...
    <script>
        ...
        function login(){
            ...
            if (loginAct == "" || loginPwd == ""){
                ...
                //如果账号密码为空，则需要及时强制终止改方法
                return false;
            }

            //去后台验证登录相关的操作
            $.ajax({
                url:"crm/settings/user/login.do",
                data:{
                    "loginAct":loginAct,
                    "loginPwd":loginPwd
                },
                ...
                success:function (data){
                    ...
                    * */
                    if (data.success){
                        //跳转到工作台的初始页（欢迎页面）
                        window.location.href = "crm/workbench/index.jsp";
                    }else{
                        $("#msg").html(data.msg);
                    }
                }
...
<div style="position: absolute; top: 120px; right: 100px;width:450px;height:400px;border:1px solid #D5D5D5">
    <div style="position: absolute; top: 0px; right: 60px;">
        ...
        <form action="crm/workbench/index.html" class="form-horizontal" role="form">
