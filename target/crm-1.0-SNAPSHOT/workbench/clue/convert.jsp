...
<script type="text/javascript">
	$(function(){
		...
		$("#convertBtn").click(function (){
			 ...
			 * 请求结束后，最终响应回线索列表页
			 *
			 * 根据 “为客户创建交易” 的复选框有没有挑勾来判断，是否需要创建交易
			 */
			if ($("#isCreateTransaction").prop("checked")){

				//需要创建交易，除了要为后台传递clueId之外，还得为后台传递交易表单中的信息，金额，预计成交日期，交易名称，阶段，市场活动源（id）
				...
				//提交表单的参数不用手动挂载（表单中写name属性），提交表单能够提交post请求

				//提交表单
				$("#tranForm").submit();

			}else{
				//不需要交易的时候，传一个clueIdj就可以了
...
<body>
	...
	<!--
		...
		其他所有的隐含对象一概不能省略（如果省略掉了，会变成从域对象取值）
	-->
