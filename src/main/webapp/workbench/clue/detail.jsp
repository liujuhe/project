				...
				success:function (data){
					...
					* */
					if (data.success){
						...
						html += '<h5 id="c'+data.cr.id+'">'+data.cr.noteContent+'</h5>'
						html += '<font color="gray">线索</font> <font color="gray">-</font> <b>${c.fullname}</b> <small style="color: gray;" id="s'+data.cr.id+'">'+(data.cr.editFlag==0?data.cr.createTime:data.cr.editTime)+'由'+(data.cr.editFlag==0?data.cr.createBy:n.editBy)+'</small>'
					...
					success:function (data){
						...
						* */
						if (data.success){
							...
							//清理搜索框中的信息  复选框的勾干掉 	清空activitySearchBody中的内容
							$("#aname").val("");
		...
		<div class="modal-dialog" role="document" style="width: 40%;">
			<div class="modal-content">
				<div class="modal-header">
					...
					<h4 class="modal-title" id="myModalLabelRemark">修改备注</h4>
				</div>
				<div class="modal-body">
					<form class="form-horizontal" role="form">
						<div class="form-group">
