    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            $("#addBtn").click(function (){
                ...
                *   操作模态窗口的方式：
                *
                *       需要操作的模态窗口的jquery对象，调用modal方法，为改方法传递参数 show：打开模态窗口 hide：关闭模态窗口
                * */
            ...
            * */
            ...
            $("#deleteBtn").click(function (){
                ...
                if ($xz.length==0){
                    ...
                    if (confirm("确定选择需要删除的记录吗？")){
                        //url:workbench/activity/delete.do?id=?
        ...
        *       1、点击左侧菜单“市场活动”超链接，需要刷新市场活动列表，调用pageList方法
        *       2、添加，修改，删除后，需要刷新市场活动列表，调用pageList方法
        *       3、点击查询按钮的时候，需要刷新市场活动列表，调用pageList方法
        *       4、点击分页组件的时候，调用pageList方法
        *
        *   以上为pageList方法制定了6个入口，也就是说，在以上6个操作执行完毕后我们必须调用pageList方法，刷新市场活动信息列表
        *
        * */
            ...
            <div class="modal-body">
                ...
                <form class="form-horizontal" role="form">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10" style="width: 300px;">
                            <input type="text" class="form-control tmie" id="edit-startDate" value="">
                        </div>
                        ...
                        <div class="col-sm-10" style="width: 81%;">
                            <!--
                                关于文本域testarea：
                                    ...
                                    （2）textarea虽然是以标签对的形式呈现的，但是它也是属于表单元素的范畴
