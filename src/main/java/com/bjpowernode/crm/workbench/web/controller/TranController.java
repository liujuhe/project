...
public class TranController extends HttpServlet {
    ...
    protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        }else if ("/workbench/transaction/selectContact.do".equals(path)){
    ...
    private void selectContact(HttpServletRequest request, HttpServletResponse response) {
        System.out.println("进入联系人查询模态窗口");
        String fullname = request.getParameter("contactName");

        ContactsService cs = (ContactsService) ServiceFactory.getService(new ContactsServiceImpl());
        List<Contacts> cList = cs.selectContact(fullname);

        PrintJson.printJsonObj(response,cList);
    }

    private void selectActivity(HttpServletRequest request, HttpServletResponse response) {
        System.out.println("进入市场活动查询模态窗口");
        String name = request.getParameter("activityName");

        ActivityService as = (ActivityService) ServiceFactory.getService(new ActivityServiceImpl());
        List<Activity> aList = as.selectActivity(name);
    ...
    private void pageList(HttpServletRequest request, HttpServletResponse response) {
        ...
        TranService ts = (TranService) ServiceFactory.getService(new TranServiceImpl());
        //Tran tran = ts.getPageList(skipCount,pageSize);
        List<Tran> trans = ts.pageList(skipCount,pageSize);
